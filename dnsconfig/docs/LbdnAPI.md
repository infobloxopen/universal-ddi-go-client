...
Other parameters are passed through a pointer to a `LbdnAPICreateRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `LbdnAPIDeleteRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.LbdnAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `LbdnAPIListRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.LbdnAPI.Read(context.Background(), id).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `LbdnAPIReadRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `LbdnAPIUpdateRequest` struct via the builder pattern
