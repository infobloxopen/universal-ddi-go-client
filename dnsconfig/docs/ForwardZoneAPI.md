...
Other parameters are passed through a pointer to a `ForwardZoneAPICopyRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `ForwardZoneAPICreateRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `ForwardZoneAPIDeleteRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.ForwardZoneAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `ForwardZoneAPIListRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.ForwardZoneAPI.Read(context.Background(), id).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `ForwardZoneAPIReadRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `ForwardZoneAPIUpdateRequest` struct via the builder pattern
