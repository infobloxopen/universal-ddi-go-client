...
func main() {
	...
	resp, r, err := apiClient.DnsUsageAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `DnsUsageAPIListRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.DnsUsageAPI.Read(context.Background(), id).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `DnsUsageAPIReadRequest` struct via the builder pattern
