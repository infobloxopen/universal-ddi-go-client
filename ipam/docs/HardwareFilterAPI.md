...
Other parameters are passed through a pointer to a `HardwareFilterAPICreateRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HardwareFilterAPIDeleteRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.HardwareFilterAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `HardwareFilterAPIListRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.HardwareFilterAPI.Read(context.Background(), id).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `HardwareFilterAPIReadRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HardwareFilterAPIUpdateRequest` struct via the builder pattern
