...
Other parameters are passed through a pointer to a `OptionCodeAPICreateRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `OptionCodeAPIDeleteRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.OptionCodeAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `OptionCodeAPIListRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.OptionCodeAPI.Read(context.Background(), id).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `OptionCodeAPIReadRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `OptionCodeAPIUpdateRequest` struct via the builder pattern
