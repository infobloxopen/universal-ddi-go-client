...
Other parameters are passed through a pointer to a `HostsAPIAssignTagsRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPICreateRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPIDeleteRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPIDisconnectRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := inframgmt.NewAPIClient()
	resp, r, err := apiClient.HostsAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `HostsAPIListRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPIReadRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPIReplaceRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPIUnassignTagsRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HostsAPIUpdateRequest` struct via the builder pattern
